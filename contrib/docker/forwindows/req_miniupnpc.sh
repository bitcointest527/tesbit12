...
cd /tmp
wget 'http://miniupnp.tuxfamily.org/files/download.php?file=miniupnpc-2.0.20190203.tar.gz' -O miniupnpc-2.0.20190203.tar.gz
tar xzf miniupnpc-2.0.20190203.tar.gz
cd /tmp/miniupnpc-2.0.20190203
...
cd /tmp
ln -s miniupnpc-2.0.20190203 miniupnpc
