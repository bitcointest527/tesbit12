...
class WalletTest(bitcoinphantomTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 XSH from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 XSH in block rewards plus fees, but
        ...
        # Send 10 XSH with subtract fee from amount
        ...
        # Sendmany 10 XSH with subtract fee from amount
