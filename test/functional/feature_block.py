...
class FullBlockTest(bitcoinphantomTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bitcoinphantomd isn't accepting b26
        ...
        # Extend the b28 chain to make sure bitcoinphantomd isn't accepting b28
        ...
        self.log.info("Reject a block with a timestamp >10 seconds in the future")
        self.move_tip(44)
        ...
        # bitcoinphantomd doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the bitcoinphantom code has custom code which does so);
