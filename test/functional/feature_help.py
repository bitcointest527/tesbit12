...
"""Verify that starting bitcoinphantom with -h works as expected."""
import subprocess

from test_framework.test_framework import bitcoinphantomTestFramework
from test_framework.util import assert_equal

class HelpTest(bitcoinphantomTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinphantom with -h for help text")
        ...
        self.log.info("Start bitcoinphantom with -version for version information")
        ...
        self.log.info("Start bitcoinphantomd with -fakearg to make sure it does not start")
