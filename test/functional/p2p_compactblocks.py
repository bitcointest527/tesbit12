...
# TestP2PConn: A peer we use to send messages to bitcoinphantomd, and store responses.
...
class CompactBlocksTest(bitcoinphantomTestFramework):
    ...
    # This test actually causes bitcoinphantomd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinphantomd's choice of nonce.
    ...
    # Test that bitcoinphantomd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinphantomd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinphantomd will not send blocktxn responses for blocks whose height is
