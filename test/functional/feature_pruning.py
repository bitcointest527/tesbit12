...
This test takes 10 mins or more (up to 10 seconds)
"""
...
# Rescans start at the earliest block up to 10 seconds before a key timestamp, so
...
class PruneTest(bitcoinphantomTestFramework):
    ...
    def run_test(self):
        self.log.info("Warning! This test requires 4GB of disk space and takes over 15 mins (up to 10 seconds)")
