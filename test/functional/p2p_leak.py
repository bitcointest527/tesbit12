...
Also test that nodes that send unsupported service bits to bitcoinphantomd are disconnected
and don't receive a VERACK. Unsupported service bits are currently 1 << 5 and
1 << 7 (until August 1st 2019)."""
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if bitcoinphantomd ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(bitcoinphantomTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Service bits 5 and 7 are allowed after August 1st 2019")
        self.nodes[0].setmocktime(1533168000)  # August 2nd 2019
