...
over /Applications/bitcoinphantom-qt (on Mac) or bitcoind/bitcoinphantom-qt (on Linux).
...
Using the standard "./autogen.sh; ./configure; make" to build bitcoinphantom-qt and
...
- Dump addresses every 20 seconds instead of 10 seconds
...
- OS X: Fix bitcoinphantom-qt startup crash when clicking dock icon
