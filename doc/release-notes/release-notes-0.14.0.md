...
bitcoinphantom has supported automatically pruning the blockchain since 0.11. Pruning
...
When bitcoinphantom is out-of-sync on startup, a semi-transparent information
...
Commands sent over the JSON-RPC interface and through the `bitcoinphantom-cli` binary
can now use named arguments. This follows the [JSON-RPC specification](http://www.jsonrpc.org/specification)
for passing parameters by-name with an object.

`bitcoinphantom-cli` has been updated to support this by parsing `name=value` arguments
when the `-named` option is given.

Some examples:

    src/bitcoinphantom-cli -named help command="help"
    src/bitcoinphantom-cli -named getblockhash height=0
    src/bitcoinphantom-cli -named getblock blockhash=000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f
    src/bitcoinphantom-cli -named sendtoaddress address="(snip)" amount="1.0" subtractfeefromamount=true
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of bitcoinphantom. This was added in conjunction with
