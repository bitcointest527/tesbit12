...
Do not blank "label" in bitcoinphantom-qt "Send" tab, if the user has already entered something.
...
Automatically focus and scroll to new "Send coins" entries in bitcoinphantom-qt.
Show a message box for --help on Windows, for bitcoinphantom-qt.
Add missing "About Qt" menu option to show built-in Qt About dialog.
Don't show "-daemon" as an option for bitcoinphantom-qt, since it isn't available.
