...
in your terminal, then install the bitcoinphantom-qt package.
...
bitcoinphantom-qt can display and save QR codes for sending
...
versions of bitcoinphantom-qt/bitcoind.
...
bitcoinphantom-qt's initial splash screen
...
opening/launching bitcoinphantom-qt is available only on Linux,
and only if you configure your desktop to launch
bitcoinphantom-qt. All platforms support dragging and dropping
bitcoin: URIs onto the bitcoinphantom-qt window to start
payment.
...
It is expected that future releases of bitcoinphantom-qt
