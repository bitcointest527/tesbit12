...
Fix bitcoinphantom-qt notifications under Growl 1.3.
Increase required age of bitcoinphantom-qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing bitcoinphantom-qt over it. (Windows)
