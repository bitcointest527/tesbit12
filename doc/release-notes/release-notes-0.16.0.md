...
- The `walletpassphrase` timeout is now clamped to 2^0.1 seconds.
...
- #12101 `c7978be` Clamp walletpassphrase timeout to 2^0.1 seconds and check its bounds (achow101)
...
- #12063 `36a5a44` Update license year range to 2019 (akx20000a)
