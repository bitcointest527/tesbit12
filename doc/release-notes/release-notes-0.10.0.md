...
installer (on Windows) or just copy over /Applications/bitcoinphantom-qt (on Mac) or
bitcoind/bitcoinphantom-qt (on Linux).
...
- `bd0aa10` Replace the temporary file hack currently used to change bitcoinphantom-qt's dock icon (OS X) with a buffer-based solution
