...
These are the dependencies currently used by bitcoinphantom Core. You can find instructions for installing them in the `build-*.md` file for your platform.
...
| MiniUPnPc | [2.0.20190203](http://miniupnp.free.fr/files) |  | No |  |  |
