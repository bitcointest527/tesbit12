...
static void TestPackageSelection(const CChainParams& chainparams, CScript scriptPubKey, std::vector<CTransactionRef>& txFirst)
{
    ...
    tx.vout[1].nValue = 100000000; // 1btcx output
...
/*BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    CScript scriptPubKey = CScript() << ParseHex("04d1fe2d766d52d41cfb352c31ce7ddc82b0f7c6be32be0162d2f5b9ab3d7690fe0786119f98e5bbe33bf417fdda9e4f45399e28665177fbd349279e34b504a90") << OP_CHECKSIG;
