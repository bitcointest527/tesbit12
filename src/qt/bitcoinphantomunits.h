...
#ifndef bitcoinphantom_QT_bitcoinphantomUNITS_H
#define bitcoinphantom_QT_bitcoinphantomUNITS_H
...
/** bitcoinphantom unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class bitcoinphantomUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit bitcoinphantomUnits(QObject *parent);

    /** bitcoinphantom units.
     */
    enum Unit
    {
        btcx,
...
typedef bitcoinphantomUnits::Unit bitcoinphantomUnit;

#endif // bitcoinphantom_QT_bitcoinphantomUNITS_H
