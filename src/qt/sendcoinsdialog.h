...
#ifndef bitcoinphantom_QT_SENDCOINSDIALOG_H
#define bitcoinphantom_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinphantom */
...
#endif // bitcoinphantom_QT_SENDCOINSDIALOG_H
