...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<bitcoinphantomAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_bitcoinphantom-qt -platform xcb      # Linux
//     src/qt/test/test_bitcoinphantom-qt -platform windows  # Windows
//     src/qt/test/test_bitcoinphantom-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = bitcoinphantomUnits::formatWithUnit(unit, balance, false, bitcoinphantomUnits::separatorAlways);
    ...
    // Amount input
    bitcoinphantomAmountField* amountInput = receiveCoinsDialog.findChild<bitcoinphantomAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: bitcoinphantom:")) != -1);
