#ifndef bitcoinphantom_QT_MESSAGEMODEL_H
#define bitcoinphantom_QT_MESSAGEMODEL_H
#include <uint256.h>
#include <vector>
 ...
 struct MessageTableEntry
{
 ...
 /** Interface to bitcoinphantom Secure Messaging (VISP) from Qt view code. */
 ...
 public:
     ...
     enum StatusCode // Returned by sendMessages
    {
     ...
     enum ColumnIndex {
        ...
        ToAddress = 4, /**< To bitcoinphantom address */
        FromAddress = 5, /**< From bitcoinphantom address */
        Message = 6, /**< Plaintext */
        TypeInt = 7, /**< Plaintext */
        Key = 8, /**< chKey */
...
#endif // bitcoinphantom_QT_MESSAGEMODEL_H
