...
#ifndef bitcoinphantom_QT_WALLETMODEL_H
#define bitcoinphantom_QT_WALLETMODEL_H
...
/** Interface to bitcoinphantom wallet from Qt view code. */
...
#endif // bitcoinphantom_QT_WALLETMODEL_H
