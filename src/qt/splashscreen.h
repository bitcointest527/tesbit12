...
#ifndef bitcoinphantom_QT_SPLASHSCREEN_H
#define bitcoinphantom_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. bitcoinphantom Core initialization
...
#endif // bitcoinphantom_QT_SPLASHSCREEN_H
