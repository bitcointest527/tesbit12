    ...
    mapper(0)
{
    ...
    ui->bitcoinphantomAtStartup->setToolTip(ui->bitcoinphantomAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinphantomAtStartup->setText(ui->bitcoinphantomAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openbitcoinphantomConfButton->setToolTip(ui->openbitcoinphantomConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new bitcoinphantomUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinphantomAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openbitcoinphantomConfButton_clicked()
{
    ...
    if (!GUIUtil::openbitcoinphantomConf())
