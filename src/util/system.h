 ...
 */
#ifndef bitcoinphantom_UTIL_SYSTEM_H
#define bitcoinphantom_UTIL_SYSTEM_H
...
extern const char * const bitcoinphantom_CONF_FILENAME;
extern const char * const bitcoinphantom_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinphantom-%s", name);
...
#endif // bitcoinphantom_UTIL_SYSTEM_H
