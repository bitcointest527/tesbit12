...
#ifndef bitcoinphantom_POLICY_FEES_H
#define bitcoinphantom_POLICY_FEES_H
...
private:
     ...
     */
    static constexpr double MIN_BUCKET_FEERATE = 10 * CENT;
...
#endif // bitcoinphantom_POLICY_FEES_H
