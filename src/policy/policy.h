...
#ifndef bitcoinphantom_POLICY_POLICY_H
#define bitcoinphantom_POLICY_POLICY_H
...
static const unsigned int DUST_RELAY_TX_FEE = CENT;
/**
...
#endif // bitcoinphantom_POLICY_POLICY_H
