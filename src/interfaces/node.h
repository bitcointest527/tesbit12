...
#ifndef bitcoinphantom_INTERFACES_NODE_H
#define bitcoinphantom_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinphantom node (bitcoinphantomd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // bitcoinphantom_INTERFACES_NODE_H
