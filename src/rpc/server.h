...
#ifndef bitcoinphantom_RPC_SERVER_H
#define bitcoinphantom_RPC_SERVER_H
...
/**
 * bitcoinphantom RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount SafeAmountFromValue(const UniValue& value);
...
#endif // bitcoinphantom_RPC_SERVER_H
