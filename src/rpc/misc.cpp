...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The bitcoinphantom address to use for the signature.\n"
...
static UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "bitcoinphantom-cli and the GUI. There is no server-side difference."
        );
...
UniValue setalgo(const JSONRPCRequest& request)
{
    ...
    throw std::runtime_error(
        ...
        "Uses the same input as commandline parameters or bitcoinphantom.conf\n"
...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total bitcoinphantom balance of the wallet\n"
