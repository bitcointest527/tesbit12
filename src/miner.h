...
#ifndef bitcoinphantom_MINER_H
#define bitcoinphantom_MINER_H
...
private:
    ...
    bool TestPackage(uint64_t packageSize, int64_t packageSigOpsCost, uint32_t txTime) const;
