...
#ifndef bitcoinphantom_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define bitcoinphantom_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // bitcoinphantom_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
