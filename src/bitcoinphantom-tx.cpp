...
static void SetupbitcoinphantomTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf("%s bitcoinphantom-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  bitcoinphantom-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinphantom transaction\n" +
              "  bitcoinphantom-tx [options] -create [commands]   Create hex-encoded bitcoinphantom transaction\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinphantom transaction
