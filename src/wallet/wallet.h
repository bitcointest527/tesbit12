...
#ifndef bitcoinphantom_WALLET_WALLET_H
#define bitcoinphantom_WALLET_WALLET_H
...
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 10 * CENT;
...
public:
     ...
     * on this bitcoinphantom node, and set to 0 for transactions that were created
...
#endif // bitcoinphantom_WALLET_WALLET_H
