...
#ifndef bitcoinphantom_AMOUNT_H
#define bitcoinphantom_AMOUNT_H
 ...
 *
 * Note that this constant is *not* the total money supply, which in bitcoinphantom
 * currently happens to be less than 16,555,000,000 btcx for various reasons, but
